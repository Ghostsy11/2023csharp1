...
namespace IfOpdracht1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (true)//vervang false met een test of nummerA gelijk is aan nummerC
            {
            ...
            if (true)//vervang false met een test of nummerA + nummerC gelijk is aan nummerB
            {
                Console.WriteLine("nummerA+ nummerC is gelijk aan nummerC");//deze moet je zien
            }


            if (true)//vervang false met een test of nummerA NIET (!) gelijk is aan nummerB
            {
